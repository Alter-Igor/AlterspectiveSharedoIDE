(function()
{
    var createModel = function(actionModel, actionOptions, wfModel, stepModel)
    {
        ...
        self.ui.pausedDateVariable = self.trackVariable(self.config.pausedDateVariable, "/String");
        ...
        self.ui.resumedDateVariable = self.trackVariable(self.config.resumedDateVariable, "/String");
        ...
        self.ui.nextAdviceDateVariable = self.trackVariable(self.config.nextAdviceDateVariable, "/String");
