 ...
 * @returns {} 
 */
BasicExamplesOfAllIdeComponents.WidgetDataComposorWithDesignerDesigner = function(element, configuration, baseModel)
{
    var self = this;
    var defaults =
    {
 ...
 */
BasicExamplesOfAllIdeComponents.WidgetDataComposorWithDesignerDesigner.prototype.onDestroy = function()
{
    var self = this;
};
 ...
 * into it's model
 */
BasicExamplesOfAllIdeComponents.WidgetDataComposorWithDesignerDesigner.prototype.loadAndBind = function()
{
    var self = this;
};
 ...
 */
BasicExamplesOfAllIdeComponents.WidgetDataComposorWithDesignerDesigner.prototype.getModel = function()
{
    var self = this;
    return {
